...
function create() {
    ...
    */
    ...
    // UP RIGHT DOWN LEFT
    upArrow = stage.input.keyboard.addKey(Phaser.Keyboard.UP);
    rightArrow = stage.input.keyboard.addKey(Phaser.Keyboard.RIGHT);
    downArrow = stage.input.keyboard.addKey(Phaser.Keyboard.DOWN);
    leftArrow = stage.input.keyboard.addKey(Phaser.Keyboard.LEFT);
    ...
    upArrow.onDown.add(move, this);
    downArrow.onDown.add(move, this);
    leftArrow.onDown.add(move, this);
    rightArrow.onDown.add(move, this);
